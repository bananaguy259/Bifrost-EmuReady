package com.solar.aurora.receivers
...
class BootReceiver : BroadcastReceiver() {
    ...
    companion object {
        private const val STARTUP_CHANNEL_ID = "aurora_startup_channel"
    ...
    private fun showMediaProjectionRequiredNotification(context: Context) {
        ...
        val notification = NotificationCompat.Builder(context, STARTUP_CHANNEL_ID)
            ...
            .setContentText("Last preset needs screen capture permission. Open Aurora to start it.")
