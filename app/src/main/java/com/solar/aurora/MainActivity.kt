...
import com.solar.aurora.services.AppProfileManager
import com.solar.aurora.services.HeimdallStartupManager
import com.solar.aurora.services.LEDService
import com.solar.aurora.services.ServiceController
import com.solar.aurora.tools.DeviceInfo
import com.solar.aurora.tools.PerformanceProfile
import com.solar.aurora.ui.AnimatedRainbowDrawable
import com.solar.aurora.ui.AuroraAlertDialog
import com.solar.aurora.ui.ColorPickerDialog
import com.solar.aurora.ui.LockableHorizontalScrollView
import com.solar.aurora.ui.RagnarokWarningDialog
...
class MainActivity : AppCompatActivity() {
    ...
    private fun maybeAutoStartFromWidget(intent: Intent?) {
        if (intent?.getBooleanExtra(
                com.solar.aurora.widget.AuroraWidgetProvider.EXTRA_AUTO_START_FROM_WIDGET,
                false
            ) != true
        ) return
        intent.removeExtra(com.solar.aurora.widget.AuroraWidgetProvider.EXTRA_AUTO_START_FROM_WIDGET)
